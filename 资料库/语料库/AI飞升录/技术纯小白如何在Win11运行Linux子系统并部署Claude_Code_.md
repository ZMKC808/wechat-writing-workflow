...
将下载的`Ubuntu2404-240425.AppxBundle`保存至本地路径（如 `D:\Ubuntu\`）。

打开 PowerShell导航到`cd D:\Ubuntu`回车再输入`Add-AppxPackage .\Ubuntu2404-240425.AppxBundle`回车后安装成功。
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/FTOSnyk3X7OF2sYNszmXWGJvjOYCt3R8D7R5qHvjOcrV2ZIgY4zfRxFLn9ztdr64Xbukq3Fv3aexWj3qThntKQ/640?wx_fmt=jpeg)
